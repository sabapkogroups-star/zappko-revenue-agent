...
import { getSelectedLead, setSelectedLead, incrementOutreach } from '@/lib/storage';
    ...
    return (
      <div className="p-4 md:p-8 max-w-4xl">
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-white">Outreach Generator</h1>
        ...
        {leads.length > 1 && (
          <div className="relative shrink-0">
            <button
              ...
              className="text-sm px-3 py-2 bg-zinc-800 border border-zinc-700 text-zinc-300 hover:text-white rounded-lg transition-colors whitespace-nowrap"
            >
              Switch Lead ↓
            </button>
            {showPicker && (
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        {emailOk ? (
          <a
            ...
            className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-5 py-3 sm:py-2.5 rounded-lg text-sm font-semibold transition-colors w-full sm:w-auto"
          >
          ...
          <div
            ...
            className="flex items-center justify-center gap-2 bg-zinc-800 border border-zinc-700 text-zinc-500 px-5 py-3 sm:py-2.5 rounded-lg text-sm font-semibold cursor-not-allowed select-none w-full sm:w-auto"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
              <polyline points="22,6 12,13 2,6" />
        ...
        {phoneOk ? (
          <a
            ...
            className="flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white px-5 py-3 sm:py-2.5 rounded-lg text-sm font-semibold transition-colors w-full sm:w-auto"
          >
